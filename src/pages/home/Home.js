      ...
      <div>
        ...
        <div className="row info-area">
          ...
          <div className="col col-md-4">
            <img src="./old_hands.jpg" alt="Thème du Hackathon CSLabs" className="info-img" />
          </div>
        ...
        <div className="row info-area">
          ...
          <div className="col col-md-4">
            <img src="./edition.jpg" alt="Troisième Édition CSLabs" className="info-img" />
          </div>
          <div className="col col-md-8">
            <div className="info-text">
              <h2>
        ...
        <div className="row info-area">
          ...
          <div className="col col-md-4">
            <img src="hackathon_irl.jpg" alt="Hackathon Compétition" className="info-img" />
          </div>
        ...
        <div className="row info-area">
          <div className="col col-md-4">
            <img src="cslabs_junior.jpg" alt="CSLabs Junior Entreprise" className="info-img" />
          </div>
          <div className="col col-md-8">
            <div className="info-text">
              <h2>
