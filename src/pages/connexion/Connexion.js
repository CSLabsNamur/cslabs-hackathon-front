    ...
    return (
      <div className="Form" id="connexion-page">
        ...
        <div className="form-control">
          ...
          <input type="email" id="email" placeholder="jean@gmail.com" disabled/>
        </div>
        <div className="form-control">
          <label>Mot de passe</label>
          <input type="password" id="password" placeholder="L0L#BoURge10S" disabled/>
        </div>
        <div className="tx-centered">
          <button className="button-primary button-round" onClick={() => this.connect()} disabled>Se connecter</button>
        </div>
        {this.isConnected()}
        <style>
          {`footer {
