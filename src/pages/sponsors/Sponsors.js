    ...
    render() {
        return (
            <div id="home-page">
                    ...
                    <div id="sponsors-list">
                        <a href="#ag_insurance">
                            <img className="sponsor-img"
                                 src={process.env.REACT_APP_PUBLIC_URL + "ag_insurance_logo.png"}
                ...
                <Topic img={{
                    src: process.env.REACT_APP_PUBLIC_URL + "digital_wallonia.png",
                    alt: "Digital Wallonia"
                }}
                ...
                <Topic img={{
                    src: process.env.REACT_APP_PUBLIC_URL + "sponsors/logo_unif_big.png",
